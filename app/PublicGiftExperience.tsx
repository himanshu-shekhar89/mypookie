...
export function PublicGiftExperience({token}:{token:string}){
  ...
  const [rating,setRating]=useState(0);const [ratingNote,setRatingNote]=useState("");const [ratingState,setRatingState]=useState<"idle"|"saving"|"saved"|"error">("idle");
