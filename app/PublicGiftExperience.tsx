...
type GiftBlock={id:string;icon:string;name:string;color:string;message:string;config?:Record<string,string>};
type PublicGift={id:string;recipientName:string;theme:string;ambience:string;blocksJson:string;scheduledAt?:string|null};
