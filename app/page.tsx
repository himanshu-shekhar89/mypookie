...
const activities: Block[] = [
  ...
  { id: "excuse", icon: "⚑", name: "Our Excuse Generator", description: "You both invent one excuse for the same situation", price: 29, color: "amber", category: "Playful games", message: "Two excuses. One suspiciously convincing plan." },
...
const blockDefaults: Record<string, Record<string, string>> = {
  ...
  tapheart: { duration: "10", scoreTitle: "Official heart-catching score", tapImage: "", tapImageName: "", tapTargetLabel: "hearts" },
